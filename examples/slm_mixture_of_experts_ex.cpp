...
namespace dlib
{
    ...
    using expert_net_type = canonical_transformer::std_ffn<ACT, DO, d_model, input<matrix<float>>>;
...
int main(int argc, char** argv)
{
    try
    {
        ...
        parser.add_option("model-file", "Path for model (default: dlib_slm_moe_model.dat)", 1);
        ...
        const std::string model_file = get_option(parser, "model-file", "dlib_slm_moe_model.dat");
