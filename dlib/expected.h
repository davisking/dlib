...
//             template<class ...U>
//             constexpr expected_base(in_place_t, U&& ...) noexcept
//             : state{IS_VAL}
//             {}
...
//         >
//         struct expected_operations : private expected_move_assign<T,E>
//         {   
...
//         template <class T, class E>
//         struct expected_operations<T, E, true> : expected_move_assign<T,E>
//         {
//             using expected_move_assign<T,E>::expected_move_assign;
...
//     template <class T, class E>
//     class expected : public expected_details::expected_operations<T,E>,
...
//         using base = expected_details::expected_operations<T,E>;
