...
namespace
{
    ...
    void test_sarsa_noprior1()
    {
        ...
        //test fixed: sarsa's corner case, having only a reward and having it in the last sample
        samples.push_back(sample_type(3,0,2,0));


        sarsa<chain_model<false> > trainer;
        //trainer.be_verbose();
    ...
    class sarsa_tester : public tester
    {
    public:
        sarsa_tester (
        ) :
            tester (
                "test_sarsa",       // the command line argument name for this test
                "Run tests on the sarsa object.", // the command line argument description
