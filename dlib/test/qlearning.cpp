...
namespace
{
    ...
    using namespace std;
    dlib::logger dlog("test.qlearning");
    ...
    void test_qlearning_noprior1()
    {
        ...
        qlearning<chain_model<false> > trainer;
        //trainer.be_verbose();
    ...
    class qlearning_tester : public tester
    {
    public:
        qlearning_tester (
        ) :
            tester (
                "test_qlearning",       // the command line argument name for this test
                "Run tests on the qlearning object.", // the command line argument description
        ...
        {
            test_qlearning_noprior1();
            test_qlearning_noprior2();
        }
    };
