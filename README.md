...
This library is licensed under the Boost Software License, which can be found in [LICENSE.txt](https://github.com/davisking/dlib/blob/master/LICENSE.txt).  The long and short of the license is that you can use dlib however you like, even in closed source commercial software.
