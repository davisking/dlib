...
## -------------------------------
CUDA_PACKAGES="cuda-toolkit-${CUDA_MAJOR}-${CUDA_MINOR} libcublas-dev-${CUDA_MAJOR}-${CUDA_MINOR} libcudnn${CUDNN_VERSION_MAJOR}-dev nvidia-driver-460-server nvidia-modprobe"
